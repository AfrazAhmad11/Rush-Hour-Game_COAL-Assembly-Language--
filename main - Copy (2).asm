...
; PURPOSE:   Writes top 10 scores to file.
; ------------------------------------------------------------------------
SaveHighscores PROC
    mov edx, OFFSET filename
    call CreateOutputFile
...
; PURPOSE:   Determines if score qualifies for leaderboard and inserts it.
; ------------------------------------------------------------------------
CheckHighscore PROC
    mov eax, playerScore
    cmp eax, 0
...
; PURPOSE:   Displays final score and checks high scores logic.
; ------------------------------------------------------------------------
ShowGameOver PROC
    call Clrscr
    mov dh, 10
